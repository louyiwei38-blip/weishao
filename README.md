...
|----------|------|----------------|
| `V3-5m` | 5 分钟 | `btc-updown-5m-<unix>` |
| `V3-15m` | 15 分钟 | `btc-updown-15m-<unix>` |
| `V3-1h` | 1 小时 | `btc-updown-1h-<unix>` |
...
| 命令 | 说明 |
|------|------|
| `npm run pm2:start` | 实盘三开 **V3-5m + V3-15m + V3-1h** |
| `npm run pm2:dry` | 模拟盘三开 |
| `npm run pm2:restart` | 重启三实例 |
| `npm run pm2:stop` | 停止三实例 |
| `npm run pm2:logs` | 查看日志 |
| `npm run start:5m` / `start:15m` / `start:1h` | 单进程实盘 |
